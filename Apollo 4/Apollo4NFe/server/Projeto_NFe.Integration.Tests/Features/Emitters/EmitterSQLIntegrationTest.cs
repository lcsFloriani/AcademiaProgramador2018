...
//            Emitter conveyor = ObjectMother.GetEmitter(ObjectMother.GetAddress(), ObjectMother.GetCnpj());
//            int expectedId = 1;

//            //Ação
//            var addEmitter = _service.Add(conveyor);
...
//        {
//            //Cenário
//            Emitter conveyor = ObjectMother.getEmitterInvalidFantasyName(ObjectMother.GetAddress(), ObjectMother.GetCnpj());

//            //Ação
//            Action addEmitter = () => _service.Add(conveyor);
...
//        {
//            //Cenário
//            Emitter conveyor = ObjectMother.getEmitterInvalidCompanyName(ObjectMother.GetAddress(), ObjectMother.GetCnpj());
...
//        {
//            //Cenário
//            Emitter conveyor = ObjectMother.getEmitterInvalidCnpj(ObjectMother.GetAddress(), null);
...
//        {
//            //Cenário
//            Emitter conveyor = ObjectMother.getEmitterInvalidStateRegistration(ObjectMother.GetAddress(), ObjectMother.GetCnpj());
...
//        {
//            //Cenário
//            Emitter conveyor = ObjectMother.getEmitterInvalidMunicipalRegistration(ObjectMother.GetAddress(), ObjectMother.GetCnpj());
...
//            Emitter conveyor = _service.Get(searchId);
//            conveyor.CompanyName = newCompanyName;

//            //Ação
//            var updateEmitter = _service.Update(conveyor);
...
//            //Ação
//            Action updateEmitter = () => _service.Update(conveyor);
