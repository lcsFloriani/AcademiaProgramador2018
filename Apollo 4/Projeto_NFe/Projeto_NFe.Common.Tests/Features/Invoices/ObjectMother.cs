...
namespace Projeto_NFe.Common.Tests.Base
{
    public partial class ObjectMother
    {
        ...
        public static InvoiceInProcess GetInvoiceInProcessWithOutConveyor(Emitter emitter, Receiver receiver, List<ItemInvoice> itens)
        {
            return new InvoiceInProcess
            {
                Emitter = emitter,
        ...
        public static InvoiceIssued GetInvoiceIssued(Conveyor conveyor, Emitter emitter, Receiver receiver, List<ItemInvoice> itens, Tax tax, AccessKey key)
        {
