// Privadas
const NDDConfigFormatterPlugin = require('ndd-config-formatter-plugin');
...
let isTestBuild;
let isPR;
const GRID_FILTER_OP = require('./utils/grid-filter-operators-values');

// Globais
const DEV_METADATA = {
    API_URL_LOCAL: 'http://localhost:9000/',
...
const getPlugins = () => {
    ...
    const plugins = [
        ...
        new webpack.DefinePlugin({
            ...
            // Variáveis dos operadores dos filtros do grid.
            GRID_FILTER_OP_STRING: JSON.stringify(GRID_FILTER_OP.STRING_TYPE),
            GRID_FILTER_OP_NUMBER: JSON.stringify(GRID_FILTER_OP.NUMBER_TYPE),
            GRID_FILTER_OP_LOGICAL: JSON.stringify(GRID_FILTER_OP.LOGICAL_TYPE),
