...
{
    public class FunctionaryUpdateCommand
    {
        ...
        class Validator : AbstractValidator<FunctionaryUpdateCommand>
        {
            ...
            public Validator()
            {
                ...
                RuleFor(x => x.User).NotNull().NotEmpty().WithMessage("O nome de usuario não pode ser nulo ou vazio!");
                RuleFor(x => x.Password).NotNull().NotEmpty().WithMessage("A senha não pode ser nulo ou vazio!");
