...
export class GeneralService extends BehaviorSubject<GridDataResult> {
    public loading: boolean;
    private BASE_URL: string = 'http://localhost:9005/api/';
    constructor(
...
@Injectable()
export class ProductGridService extends GeneralService {
